...
public class WiFiDirectActivity extends Activity implements ChannelListener, DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            fragmentDetails = (DeviceDetailFragment) fm.findFragmentByTag("FragDetails");
        }
        // If the Fragment is non-null, then it is currently being
        // retained across a configuration change.
        else if (fragmentDetails == null) {
            fragmentDetails = (DeviceDetailFragment) getFragmentManager()
                    .findFragmentById(R.id.frag_detail);
            fm.beginTransaction().replace(R.id.frag_detail, fragmentDetails, "FragDetails").addToBackStack(null).commit();
        }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState){
        Log.d("hi", "Activity onSaveInstanceState Called");
